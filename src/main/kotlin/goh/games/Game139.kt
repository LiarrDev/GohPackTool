...
class Game139(apk: String) : Game(apk) {
    ...
    override fun replaceResource(loginImage: String?, loadingImage: String?, logoImage: String?, splashImage: String?) {
        val gameLoginImgPath = decompileDir + File.separator +
                ...
                "loginres" + File.separator +
                "login_bg_f_44ae01ef.jpg"
        val gameSplashImgPath = decompileDir + File.separator +
                "assets" + File.separator +
                "chameleon" + File.separator +
                "chameleon_splashscreen_0.png"
        val gameMaleRoleImgPath = decompileDir + File.separator +
                "assets" + File.separator +
                "game" + File.separator +
                "resource" + File.separator +
                "shj_assets" + File.separator +
                "picture" + File.separator +
                "bigbg" + File.separator +
                "create_role_bg1_ed9d9ee8.png"
        val gameFemaleRoleImgPath = decompileDir + File.separator +
                "assets" + File.separator +
                "game" + File.separator +
                "resource" + File.separator +
                "shj_assets" + File.separator +
