...
class Game147(apk: String) : Game(apk) {
    override fun replaceResource(loginImage: String?, loadingImage: String?, logoImage: String?, splashImage: String?) {
        val gameLoginImgPath = decompileDir + File.separator + "assets" + File.separator + "agent" + File.separator +  "login_bg_base.jpg"
        val gameLoadingImgPath = decompileDir + File.separator + "assets" + File.separator + "agent" + File.separator +  "loading_bg_base.jpg"
        val gameLogoImgPath = decompileDir + File.separator + "assets" + File.separator + "agent" + File.separator +  "logo_base.png"
        val gameSplashImgPath = decompileDir + File.separator + "assets" + File.separator + "agent" + File.separator +  "loading_bg_1.jpg"      // 内加载页
